...
/**
 ** NOTE:
 ** This file is basically a fork of gregtech/api/metatileentity/BaseTileEntity.java
 ** I had to do this as IEnergyConnected also implements IHasWorldObjectAndCoords
 ** Which requires the te to implement many methods..
 ** @GregoriusT: You should move the direction stuff to an own Interface 
 **              so everyone who want's to implement your ENet does not have
 **              to implement a bunch of - in this case unsued - methods.
 **
 **/
 ...
 */
public abstract class BaseGTProducerTileEntity<T> extends TileEntityEnergyProducer<T> implements IHasWorldObjectAndCoords {
	/**
    ...
    public BaseGTProducerTileEntity(PowerSystem powerSystem, int voltageNameIndex, Class<T> adjacentClass) {
